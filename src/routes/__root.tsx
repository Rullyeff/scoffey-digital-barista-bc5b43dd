...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Scoffey Digital Barista" },
      { name: "description", content: "AI-enabled beverage co-creation for Scoffey." },
      { name: "author", content: "Scoffey" },
      { property: "og:title", content: "Scoffey Digital Barista" },
      { property: "og:description", content: "AI-enabled beverage co-creation for Scoffey." },
